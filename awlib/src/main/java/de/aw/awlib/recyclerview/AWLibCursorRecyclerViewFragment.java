...
public abstract class AWLibCursorRecyclerViewFragment extends AWLibLoaderFragment
    ...
    public CursorRecyclerViewAdapter getCursorAdapter() {
        return new CursorRecyclerViewAdapter(this);
    }
     ...
     *
     * @return Liefert als ViewType {@link AWLibCursorRecyclerViewFragment#DEFAULTVIEWTYPE} zurueck
     */
    @Override
     ...
     *         zurueckgegeben.
     * @see CursorRecyclerViewAdapter.CursorViewHolderBinder#onBindViewHolder
     */
    @Override
