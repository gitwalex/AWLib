...
public class AWRemoteFileServerHandler {
    ...
    /**
     * @param files
     *         die nach Abschluss von {@link AWRemoteFileServerHandler#listFilesInDirectory(String,
     *         FTPFileFilter)} oder {@link AWRemoteFileServerHandler#listFiles(FTPFileFilter)}
     *         ermittelten Files.
     */
    ...
    public interface ExecutionListener {
         ...
         *
         * @param result
         *         Die {@link AWRemoteFileServerHandler.ConnectionFailsException}, wenn Fehler
         *         aufgetretn sind. Ansonsten null.
         */
        void onEndFileServerTask(AWRemoteFileServerHandler.ConnectionFailsException result);
    ...
    private abstract class RemoteFileServerTask
            extends AsyncTask<Void, Void, AWRemoteFileServerHandler.ConnectionFailsException> {
        /**
