 ...
 */
public class AWLibBottomSheetDialog extends ExpandedBottomSheetDialog {
     ...
     *         Context
     * @param arrayID
     *         ID eines StringArray. Diese ID wird bei {@link AWLibBottomSheetDialog#onBottomSheetItemClick(int,
     *         int, Bundle, CheckedTextView)} zuruckgeliefert
     */
    public AWLibBottomSheetDialog(Context context, int arrayID) {
        super(context);
        mAdapter =
     ...
     *         AWLibBottomSheetDialog#onBottomSheetItemClick(int, int, Bundle, CheckedTextView)}
     * @param items
     *         Items fuer BottomSheet
     */
    public AWLibBottomSheetDialog(Context context, int id, String[] items) {
        super(context);
     ...
     *         Items fuer BottomSheet
     */
    public AWLibBottomSheetDialog(Context context, int id, List<String> items) {
        super(context);
     ...
     * <p/>
     * Ruf eines ggfs in {@link AWLibBottomSheetDialog#setItemClickListener(BottomSheetListener)}
