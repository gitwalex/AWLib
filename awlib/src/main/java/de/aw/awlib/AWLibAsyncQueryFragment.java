 ...
 * abgeschaltet. Daher ist zwingend beim Ueberschreiben von {@link AWLibAsyncQueryFragment#onQueryComplete(int,
 * Object, Cursor)} super(...) zu rufen! }</p>
 */
public abstract class AWLibAsyncQueryFragment extends AWLibFragment {
    ...
    protected static class QueryHandler extends AsyncQueryHandler {
        private final AWLibAsyncQueryFragment mFragment;

        public QueryHandler(AWLibAsyncQueryFragment fragment) {
        ...
        public void startQuery(int token, Object cookie, Uri uri, String[] projection,
            ...
            AWLIbApplication.Log("MonMaAsyncQuery: Starting Query");
