 ...
 */
public class AWLibEditText extends EditText implements AWLibInterface {
    private String aktuellerText;
    private int mBroadcastIndex;
    private AWLibAutoCompleteTextView.OnTextChangedListener mOnTextChangedListener;

    public AWLibEditText(Context context) {
        super(context);
    }

    public AWLibEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AWLibEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOnTextChangedListener(AWLibAutoCompleteTextView.OnTextChangedListener listener) {
