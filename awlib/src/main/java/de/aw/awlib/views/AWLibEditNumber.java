...
public class AWLibEditNumber extends AWLibEditText {
    ...
    public AWLibEditNumber(Context context) {
        super(context);
    }

    public AWLibEditNumber(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AWLibEditNumber(Context context, AttributeSet attrs, int defStyleAttr) {
